...
def make_phenotype_label_matrix(phenotypes, stays=None):
    ...
    if stays is not None:
        #print(stays.ICUSTAY_ID.sort_values())
        #print(stays.ICUSTAY_ID.isnull().sum())
        #phenotypes = phenotypes.loc[stays.ICUSTAY_ID.sort_values().index]
        phenotypes = phenotypes.sort_values(by="ICUSTAY_ID")
